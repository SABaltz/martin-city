        ...
        <Box sx={{flexGrow: 1}}>
            <AppBar position="static" sx={{ backgroundColor: secondaryColor}}>
                <Grid container>
                    ...
                    <Grid item xs={12} sm={4} md={2}><Typography sx={{...centerVertHoriz}}><Mail sx={{paddingRight: '.5rem'}}
                                                                                          onClick={handleEmailClick}/>glaciernationalparkcamping@gmail.com</Typography></Grid>
                    <Grid item xs={12} sm={4} md={2}><Typography sx={{...centerVertHoriz}}><DirectionsIcon
                        sx={{paddingRight: '.5rem'}}
