    ...
    return (
        <Stack sx={{textAlign: 'center', ...centerVertHoriz, marginTop: '3rem', marginBottom: '3rem'}}>
            ...
            <ImageList sx={{width: '90vw'}} cols={3} rowHeight={200}>
                {itemData.map((item) => (
                    <Box onClick={() => item.title === 'Convenient Location' ? window.open("https://www.google.com/maps/place/9234+Hwy+2+E,+Columbia+Falls,+MT+59912/@48.3910565,-114.0436689,17z/data=!3m1!4b1!4m6!3m5!1s0x53663ee5fcea226b:0xa23a1e7f79093ae7!8m2!3d48.391053!4d-114.041094!16s%2Fg%2F11c2h319n3?entry=ttu") : ''} >
