...
function Description() {
    return (<Box sx={{
        ...
        <Typography sx={{margin: '4rem 4rem', fontSize: '1.5rem'}}>Martin City Park is a convenient, budget friendly camper-van and tent site campground
            ...
            portapotties, ground bike racks, and a bear-proof garbage area. </Typography>
    </Box>)
}
